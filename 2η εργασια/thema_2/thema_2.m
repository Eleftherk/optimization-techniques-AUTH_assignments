...
shm=0;
times=0;
[x k shm]=steepest_given_gk(f,[0 0],0.6)
syms x y
...
shm=0;
times=0;
[x k shm]=steepest_given_gk(f,[-1 1],0.6)
syms x y
...
shm=0;
times=0;
[x k shm]=steepest_best_gk(f,[0 0])
syms x y
...
shm=0;
times=0;
[x k shm]=steepest_best_gk(f,[-1 1])
syms x y
...
shm=0;
times=0;
[x k shm]=steepest_armijo(f,[0 0],0.6)
syms x y
...
shm=0;
times=0;
[x k shm]=steepest_armijo(f,[-1 1],0.6)
syms x y
